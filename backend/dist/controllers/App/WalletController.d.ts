export declare class WalletController {
     ...
     */
    static addBalanceViaThirdParty(req: any, res: any, next: any): Promise<void>;
    static requestBalanceViaThirdParty(req: any, res: any, next: any): Promise<void>;
    static getBalance(req: any, res: any, next: any): Promise<void>;
    static getWinningWalletBalance(req: any, res: any, next: any): Promise<void>;
}
