    ...
    static getFedexToken() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield axios.post(config.url, data, config);
    ...
    static getShippingCharges() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const token = yield this.getFedexToken();
                ...
                const response = yield axios.post(config.url, data, { headers: config.headers });
                console.log(JSON.stringify(response.data));
...
exports.default = ShippingCharges;
