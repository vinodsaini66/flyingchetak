import {
  ...
  function Channel() {
    const sectionName = "Channel";
    const routeName = "channel";
  
    const api = {
      addEdit: apiPath.channelAdd,
      list: apiPath.channelGet,
      status: apiPath.channelAdd,
    };
